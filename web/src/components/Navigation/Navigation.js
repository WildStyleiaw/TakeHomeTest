...
const CustomLink = ({ to, children }) => {
  ...
  const activeClassName =
    'group flex items-center px-2 py-2 text-lg leading-5 font-medium text-green-600 rounded-md focus:outline-none bg-gray-200 transition ease-in-out duration-150'
  const inActiveClassName =
    'group flex items-center px-2 py-2 text-lg leading-5 text-gray-600 rounded-md hover:text-green-600 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150'
  if (matchInfo.match) {
    return (
